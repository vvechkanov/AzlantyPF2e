...
SESSION_MARKERS = {
    ...
    16: {
        2: "**Вова (пленный варгаундер):** Сколько... детей жалко, они иногда милые.",
        3: "**Егорушка (Гельдала):** Не, я перекинул. Что такое, надо поддерживать репутацию.",
        4: "**Тоша (Самум, OOC):** Нам нужно убить вторую тварь. Этот не станет нападать.",
        5: "**Вова (ГМ):** Ага, ну я могу просто перетащить со стадии, супер.",
        6: "**Вова (ГМ):** Так, и ты делаешь прыжок — и что-то ещё?",
        7: "**Егорушка (Гельдала):** Ему скармливают невинных граждан — мне этого достаточно.",
        8: "**Сеня (Анканто/Микаэль):** Вроде нет. Нет, не усложняет.",
        9: "**Вова (ГМ):** Да просто вот опиши, как его разрывает или что ты с ним делаешь.",
        10: "**Егорушка (OOC):** Очень рад, что у меня сегодня в среднем были хорошие кубы",
    },
    19: {
        2: "### Встреча со сворой Кула",
        3: "#### Раунд 1 — Мосс Керик (Макракер, HP 17/17)",
        4: "### Раунд 1 — Сильвестр, Киран вытаскивает Генри",
        5: "**Раунд 1 · ход Брен Хольт (Сеня, Макракер) (HP 17/17)**",
        6: "### Раунд 2 — ход Каспара «Огарка» (HP 42/42)",
        7: "### Раунд 3 — Гельдала: рой в конусе",
        8: "### Раунд 3 · Киран меняется местами с Бель",
        9: "### Раунд 4 — ход Кула «Большеголова»",
        10: "**Вова (ГМ):** Но ты что-то говорил? Он остановится, на паузе.",
        11: "**Егорушка (Гельдала):** Пойми, друиды относятся к чистоте тела совершенно иначе.",
        12: None,  # полный фидбек-раунд; сжатый дубль вырезан из чанка 0011
        13: "**Похвала за игру в боёвке**",
    },
...
REPL = [
    ...
    # NPC, специфичные С8+
    ("Дома Ормус", "Дома Ормуз"),
    ("Дому Ормус", "Дому Ормуз"),
    ("Дом Ормус", "Дом Ормуз"),
