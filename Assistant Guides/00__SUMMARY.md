...
Правило: **сначала читаем этот SUMMARY**, затем точечно открываем нужный гайд.
...
## Что где лежит
- `01__...` — доступ и навигация: RAW-ссылки, старт с ROOT SUMMARY, правила обхода дерева.
- `02__...` — сущности проекта: какие файлы бывают и как они связаны (ROOT SUMMARY, summary папок, manifest).
- `03__...` — стандарты summary: структура, объём, якоря, оформление.
- `04__...` — рабочий процесс: как править файлы, как собирать бандл, что обязательно обновлять.
- `05__...` — «Проверить»: валидатор/политика дублей/минимальный контроль качества.
- `06__...` — manifest delete/move: как корректно удалять/переносить/переименовывать.
